...
import remotecontrolpc.desktop.Utility;
...
public class FileAPI {
    ...
    public static void main(String args[]) {
        ...
        ArrayList<AvatarFile> files = fileAPI.getFiles(path);
        for (int i = 0; i < files.size(); i++) {
            AvatarFile avatarFile = files.get(i);
            System.out.println(avatarFile.getPath());
            System.out.println(avatarFile.getHeading());
            System.out.println(avatarFile.getSubheading());
        }
    }
}
